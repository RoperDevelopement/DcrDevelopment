...
namespace EDocs.Nyp.LabReqs.AppServices.LabReqsConstants
{
    public static class ConstNypLabReqs
    {
        #region sql sp names
        #region auditlogs
        public const string SpNypAuditLogCwid = "sp_NypAuditLogCwid";
        public const string SPNypAuditLogMessageType = "sp_NypAuditLogMessageType";
        public const string SPNypAuditLogApplicationName = "sp_NypAuditLogApplicationName";
        ...
        #endregion
        #region COVID-19 sql stored proc
        ...
        public const string SpNypDohPatientNameDateOfService = "sp_NypDohPatientNameDateOfService";
        public const string SpNypDohDrFirstLastNameDateOfService = " sp_NypDohDrFirstLastNameDateOfService";
        ...
        public const string ApiNypLabReqsKeyWordsController = @"NypLabReqsKeyWords/";
        public const string ApiEditLabReqsController = @"EditLabReqs/";
        ...
        public const string FormValueSearchByMRN = "searchbyMRN";
        public const string FormValueSearchByIndexNumberCsnNumber = "searchbylabreccsnnumber";
        ...
        public const string FormValueSearchbyPatientName= "searchbyPatientName";
        ...
        public const string FormValueCSNNum = "CSNNum";
        public const string FormValueKeyWords = "keyWords";
        public const string FormValueReqsNum = "reqsNum";
        public const string FormValuePatID = "patID";
        public const string FormValueMRN = "MRN";
        ...
        public const string LRCookieReturnUrl = "LRCookieReturnUrl";
        public const string SessionLabReqEdit = "SessionLabReqEdit";
        ...
        public const string FormValueSearchMRN = "searchbyMRN";
        public const string FormValueSearchByReqNum = "searchbyreqnum";
        public const string FormValueSearchByCSNNum = "searchbyCSNnum";
        ...
        public const string FormValueSearchByKeyWord = "searchbyKeyWord";
        ...
        public const string FormCBValueCwid = "All CWID'S";
        public const string FormAppNameValueCwid = "All Application Name";
        public const string FormMessageTypeValue = "All Message";
