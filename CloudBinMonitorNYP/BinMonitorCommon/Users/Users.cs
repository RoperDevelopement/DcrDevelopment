...
namespace BinMonitor.Common
{
    public sealed class Users : SerializedObjectDictionary<User>
    {
        ...
        { get { //return @"Config\Users";
                // return string.Format("{0}\\Local\\EdocsUsaBmC\\Config\\Users", Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData));
                return BinUtilities.BinMonUserFolder;
