        ...
        */
        ...
        private void btnSaveChanges_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SpecimenCategories.Instance.Save(category.Title);
                SpecimenCategories.Instance.Reload();
              //  string s = category.CheckPoint1Configuration.Duration.ToString();
                BmSqlServerXmlFiles.AddBatchesCloud.UpdateCategorieXmlFile(category.Title);
                BinMonitorSqlServer.SqlServerInstance.CategoryColors(category);
