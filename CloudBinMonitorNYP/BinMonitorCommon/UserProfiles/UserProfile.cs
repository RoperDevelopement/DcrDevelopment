...
namespace BinMonitor.Common
{
    ...
    public sealed class UserProfiles : SerializedObjectDictionary<UserProfile>
    {
        public override string DirectoryPath
        {
            ...
            get {// return string.Format("{0}\\Local\\EdocsUsaBmC\\Config\\UserProfiles", Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData));
                return BinUtilities.BinMonUserProfilesFolder;
            }
        }
