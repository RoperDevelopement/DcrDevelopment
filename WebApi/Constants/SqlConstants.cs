...
namespace BinMonitorAppService.Constants
{
    ...
    public class SqlConstants
    {
        ...
        public const string SpNypGetAuditLogs = "[dbo].[sp_NypGetAuditLogs]";
        public const string SpUpLoadNypAuditLogs = "[dbo].[sp_UpLoadNypAuditLogs]";
        public const string SpUpdateSpectrumMonitorUsers = "[dbo].[sp_UpdateSpectrumMonitorUsers]";
        public const string SpSpectrumMonitorTransFerCategory = "[dbo].[sp_SpectrumMonitorTransFerCategory]";
        public const string SpTransFerByBinId = "[dbo].[sp_TransFerByBinId]";
        public const string SpNypLabReqUser = "[dbo].[sp_NypLabReqUser]";

        public const string SpDeleteSpUsers = "sp_DeleteSpUsers";
        public const string SpSpectrumMonitorTransFer = "sp_SpectrumMonitorTransFer";
        public const string SpAddSpectrumMonitorUserLogin = "sp_AddSpectrumMonitorUserLogin";
        public const string SpGetSpecModelUserInfo = "sp_GetSpecModelUserInfo";
        ...
        public const string SpUpDateCategoryCheckPointModel = "sp_UpDateCategoryCheckPointModel";
        public const string SpBinRegisterBatch = "sp_BinRegisterBatch";
        public const string SpCloseBinsByBinID = "sp_CloseBinsByBinID";
        public const string SpGetBinsReports = "sp_GetBinsReports";
        public const string SpGetSpectrumMonitorUserCwid = "sp_GetSpectrumMonitorUserCwid";
        public const string SpGetUserInfoCwid = "sp_GetUserInfoCwid";
        public const string SpSpectrumMonitorUserLogIn = "sp_SpectrumMonitorUserLogIn";
        public const string SpUpLoadLabRecJsonFile = "sp_UpLoadLabRecJsonFile";
        public const string SpGetLabRecs = "sp_GetLabRecs";
        ...
        public const string SpBinsModelLabRecNumber = "sp_BinsModelLabRecNumber";


        public const string SpGetActiveBinsModel = "sp_GetActiveBinsIDModel";
        ...
        public const string SpUsageChartReportByCWID = "sp_UsageChartReportByCWID";
        public const string SpTansFerByLabReqNum = "[dbo].[sp_TransFerByLabReqNum]";
        ...
        public const string SpDeleteSpecLabRec = "sp_DeleteSpecLabRec";
        public const string SpGetActiveBinUsers = "sp_GetActiveBinUsers";
        public const string SpTransFerProces = "[dbo].[sp_TransFerProces]";
       
         public const string SpTransFerReport = "sp_TransFerReport";
        ...
        public const string SpParmaOldBinId = "@OldBinId";
        ...
        public const string SpParmaTransFerBy = "@TransFerBy";
        ...
        public const string SpParmaLabRecNumber = "@LabRecNumber";
        public const string SpParmaCategorieColor1 = "@CategorieColor1";
        public const string SpParmaCategorieColor2 = "@CategorieColor2";
        public const string SpParmaCategorieColor3 = "@CategorieColor3";
        public const string SpParmaCategorieColor4 = "@CategorieColor4";
        public const string SpParmaTransFerType = "@TransFerType";
       


        public const string SpParmaDateBatchPickedUp = "@DateBatchPickedUp";
        public const string SpParmaBatchPickedUpBy = "@BatchPickedUpBy";
        ...
        public const string SpParmaViewAuditLogs = "@ViewAuditLogs";
        public const string SpParmaActive = "@Active";
        public const string SpParmaIsAdmin = "@IsAdmin";
        public const string SpParmaAction = "@Action";
        ...
        public const string SpParmAzureTableName = "@AzureTableName";
        ...
        public const string SpParamRegStatus = "@RegStatus";
        public const string SpParamProcessCompleted = "@ProcessCompleted";
        ...
        public const string SpParmaPwModify = "@PwModify";
        public const string SpParmaUserOldPw = "@UserOldPw";
        public const string OldCategoryName = "@OldCategoryName";
        public const string SpParmaOldCategoryName = "@OldCategoryName";
        public const string SpParmaChangeCategores = "@ChangeCategores";
        public const string SpParmaChangeEmail  = "@ChangeEmail";
        public const string SpParmaAuditLogDate = "@AuditLogDate";
        public const string SpParmaAuditLogApplicationName = "@AuditLogApplicationName";
        public const string SpParmaAuditLogUrl = "@AuditLogUrl";
       public const string SpParmaAuditLogMessageType = "@AuditLogMessageType";
        public const string SpParmaEditLRDocs = "@EditLRDocs";
        public const string SpParmaDeletedBy = "@DeletedBy";
        ...
        public const string CLoudConfigSqlConnectionStringLabRecs = "LabRecsCloudConnectionString";
        ...
        public const string ApiCategoryDurations = "CategoryDurations/{0}";
        ...
        public const string BatchRegistraton = "BatchRegistraton";
        ...
        public const string ApiGetUseNamePw = "GetUseNamePw/";
        public const string StrEdocsNoData = "EdocsNoData";
