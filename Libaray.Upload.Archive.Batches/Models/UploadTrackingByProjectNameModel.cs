...
{
  public  class UploadTrackingByProjectNameModel: IEdoscITSTrackingID, IArchiverTotalPages,IStandardLargeDocument, IBatchID, IEdocCustomerInfo, IPDFFilename

    {
      ...
      public  int NumberDocsScanned
        ...
        { get; set; }
      public  bool StandardLargeDocument { get; set; }
