//NOTE: Constructor modifed by e-Docs to apply licence key, remainder of file as it came from debenu.
...
// DebenuPDFLibraryDLL0915.cpp
// C# import header for .NET
// This file was generated by an automated process on 19 July 2013
// http://www.debenu.com/
...
namespace DebenuPDFLibraryDLL0915
{
    ...
    public class PDFLibrary
    {
        ...
        public enum Permission
        {
            ...
            ASSEMBLE = 64,
            PRINTFULL = 128,
            ALL = PRINT | COPY | CHANGE | ADDNOTES | FILLFIELDS | COPYACCESS | ASSEMBLE | PRINTFULL
        }

        #endregion Enums

        /// <summary>Constructor modified by e-Docs USA to initialize the licence key.</summary>
        public PDFLibrary()
        {

            // string assemblyName = @"I:\EdocsGitHub\Edocs.Libaray.AzureCloud.Upload.Batches\Edocs.Libaray.AzureCloud.Upload.Batches\bin\Debug\DebenuPDFLibraryDLL0915.dll";
            string assemblyName = "DebenuPDFLibraryDLL0915.dll";
            ETL.TraceLoggerInstance.TraceInformation($"Opening pdf assebmly:{assemblyName}");
            if (System.IO.File.Exists(assemblyName) == false)
            {
                ETL.TraceLoggerInstance.TraceError($"Opening pdf assebmly:{assemblyName}");
                throw new System.IO.FileNotFoundException("Could not find QuickPDF Assembly", assemblyName);
            }

            dll = new DLL(assemblyName);
            instanceID = dll.DebenuPDFLibraryCreateLibrary();

            dll.RegisterForShutdown(instanceID);

            if (UnlockKey("j43kt3sq9y64f679x3r53kt5y") == 0)

            {
                ETL.TraceLoggerInstance.TraceError("Error unlocking QuickPDF Library");
                throw new Exception("Error unlocking QuickPDF Library");
            }
        }

        //public void Release() { dll.Release(); }

        #endregion E-Docs Additions
    }
}
