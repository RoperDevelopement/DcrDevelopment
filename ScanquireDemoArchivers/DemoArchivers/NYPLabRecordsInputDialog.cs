...
{
    public partial class NYPLabRecordsInputDialog : Form
    {
        public void Clear()
        {
        ...
        public NYPLabRecordsInputDialog()
        {
            InitializeComponent();
        }
        ...
        private void NYPLabRecordsInputDialog_Shown(object sender, EventArgs e)
        {
