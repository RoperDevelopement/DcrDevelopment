...
{
	public class LongTermCareROIArchiver : SQFilesystemArchiver
	{
		protected class LongTermCareROIInputDialog : TableLayoutPanelInputDialog
		{			
			...
			public LongTermCareROIInputDialog() : base(2, 4)
			{ InitializeComponent(); }
		...
		protected LongTermCareROIInputDialog InputDialog = new LongTermCareROIInputDialog();
		...
		{
			return ((LongTermCareArchiver)(SQArchivers.Instance["LONG TERM CARE"])).AcquireFromFile();
		}
		...
		public LongTermCareROIArchiver()
		{
		}
	}
}
