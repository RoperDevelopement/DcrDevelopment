...
namespace Edocs.DOH.DL.Doc.Utilities
{
    public class Send_Emails
    {
        ...
        {
            EmailFrom = Edocs_Constants.EmailFrom;
            EmailTo = Edocs_Constants.EmailTo;
            EmailPassword = Edocs_Constants.EmailPassWord;
       EmailCC = Edocs_Constants.EmailCC;


            EmailServer = Edocs_Constants.EmailServer;

            EmailPort = Edocs_Constants.EmailPort;
        ...
        public void SendEmail(string emailMessage)
        {
            ...
            try
            {
                ...
                //}
                    ...
                    messageEmail.CC.Add(EmailCC);




                EmailSubject = $"Error Downloading DOH Documents email sent on{DateTime.Now.ToString("MM-dd-yyyy")}";
