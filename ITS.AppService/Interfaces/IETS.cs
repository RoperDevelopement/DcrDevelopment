...
namespace Edocs.ITS.AppService.Interfaces
{
    ...
    public interface IEdocsCustID   
    {
        int EdocsCustomerID
        { get; set; }
    }
    public interface IDocSent
    {
       bool DocSent
        { get; set; }
    }
    ...
    public interface IScanRecTotals
    {
        int TotalScanned
        { get; set; }
    ...
    public interface ITotalRecords: IScanRecTotals
    {
    ...
    public interface IIDITrackingID
    {
        string TrackingID
        { get; set; }
    }
    public interface ITrackingIDS
    {
        string TrackingIDS
        { get; set; }
    }
    ...
    public interface ICustomInvoice
    {
    ...
    public interface IPSUDDepartment
    {
        string Department { get; set; }
   }
    public interface IPSUDOrginationDepartment
    {
        string OrginationDepartment { get; set; }
    }
    public interface IPSUDRecordStartEndDate
    {
    ...
    public interface IPSUDDescriptionOfRecords
    {
        string DescriptionOfRecords { get; set; }
    }
    public interface IPSUDMethOfFiling
    {
        string MethOfFiling { get; set; }
    }
    public interface IPSUDFirstName
    {
        string  FirstName { get; set; }
    }
    public interface IPSUDLastName
    {
        string LastName { get; set; }
    }
    public interface IPSUDDateOfBirth
    {
        DateTime DateOfBirth { get; set; }
    }
    public interface IPSUDDateOfRecords
    {
        string DateOfRecords { get; set; }
    }
    public interface IPSUDTrackingID
    {
        string TrackingID { get; set; }
    }
    public interface IPSUDSearchText
    {
