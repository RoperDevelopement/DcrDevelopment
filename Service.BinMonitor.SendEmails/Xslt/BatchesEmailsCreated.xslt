        ...
        <xsl:for-each select= "BatchId/Bins">
          <div>
            ...
            <table style="width:100%">
              <caption>
                Bin Id  <xsl:value-of select="binId"/> Spectrum Id  <xsl:value-of select="batchId"/> Category <xsl:value-of select="cat"/>
              </caption>
              <tr>
                <th>Bin Status</th>
                <th>Assigned By</th>
              ...
              <tr>
                ...
                <td>
                  <xsl:value-of select="processDuration"/>
                </td>
              ...
              <tr>
                ...
                <td>
                  <xsl:value-of select="completeDuration"/>
                </td>
